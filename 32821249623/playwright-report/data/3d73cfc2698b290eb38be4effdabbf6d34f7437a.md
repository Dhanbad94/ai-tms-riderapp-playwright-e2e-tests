...
Expected: "Chicago 2"
Received: "Terminal 5E"
Timeout:  10000ms

Call log:
  - Expect "toHaveValue" with timeout 10000ms
  - waiting for getByPlaceholder('Pick-up from?')
    13 × locator resolved to <input type="text" minlength="" maxlength="" name="pickupinput" autocomplete="off" value="Terminal 5E" placeholder="Pick-up from?" class="customInput_formControl__E0KJg selectLocation_formInput__a1Uyk  "/>
       - unexpected value "Terminal 5E"
