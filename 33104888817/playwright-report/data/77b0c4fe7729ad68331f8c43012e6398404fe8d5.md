...
- Name: future-booking-only/future-time-picker.spec.ts >> Future Booking — Time Picker @future @ui-only @regression @safe >> FB_TP_004: Close (×) button dismisses the modal without setting a time
- Location: tests/on-demand/future-booking-only/future-time-picker.spec.ts:70:7
