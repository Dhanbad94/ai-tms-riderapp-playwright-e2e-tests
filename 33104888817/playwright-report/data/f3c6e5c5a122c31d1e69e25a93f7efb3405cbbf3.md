...
- Name: future-booking-only/future-api-payload.spec.ts >> Future Booking — API Payload Verification @future @payload @regression @safe >> FB_039: Random-slot booking payload includes the booking object with the picked time
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e12]:
        - generic [ref=e13]:
          - img "pickup" [ref=e20]
          - generic [ref=e21]:
            - textbox "Pick-up from?" [ref=e22]: Door 3 - Bus/Shuttle Ctr
