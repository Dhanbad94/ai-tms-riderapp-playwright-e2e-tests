...
- Name: future-booking-only/future-e2e.spec.ts >> Future Booking — End-to-End Flows (randomized) @future @creates-ride @regression >> FB_038: A second random run picks (very likely) different stops and a different time
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e12]:
        ...
        - generic [ref=e25]:
          - img "dropoff" [ref=e27]
          - generic [ref=e28]:
            - textbox "Where to?" [ref=e29]: Door 3 - Bus/Shuttle Ctr
