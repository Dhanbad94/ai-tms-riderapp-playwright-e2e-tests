...
Call log:
  ...
  - waiting for getByPlaceholder('Pick-up from?')
    12 × locator resolved to <input type="text" minlength="" maxlength="" name="pickupinput" autocomplete="off" placeholder="Pick-up from?" value=" Automated OD Future Booking" class="customInput_formControl__E0KJg selectLocation_formInput__a1Uyk  "/>
