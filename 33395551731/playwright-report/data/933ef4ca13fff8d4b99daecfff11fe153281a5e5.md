...
- Name: future-booking-only/future-e2e.spec.ts >> Future Booking — End-to-End Flows (randomized) @future @creates-ride @regression >> @sanity FB_037: Verify that a ride books with randomly selected pickup and drop-off stops and a random pickup date and time
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e12]:
        ...
        - generic [ref=e25]:
          - img "dropoff" [ref=e27]
          - generic [ref=e28]:
            - textbox "Where to?" [ref=e29]: Automated OD Future Booking
